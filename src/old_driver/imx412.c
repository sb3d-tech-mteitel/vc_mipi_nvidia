...
#define TRACE_IMX412_SET_FRAME_RATE     1   /* DDD - imx412_set_frame_rate() - trace */
...
{
#define TRACE_IMX412_POWER_ON   1   /* DDD - imx412_power_on() - trace */
...
#define TRACE_IMX412_POWER_OFF  1   /* DDD - imx412_power_off() - trace */
...
#define TRACE_IMX412_POWER_GET  1   /* DDD - imx412_power_get() - trace */
...
static int vc_mipi_common_trigmode_write(struct i2c_client *rom, u32 sensor_ext_trig, u32 exposure_time, u32 io_config, u32 enable_extrig, u32 sen_clk)
{
    ...
    if(sensor_ext_trig)
    {
		...
		//exposure = (exposure_time * 24 or 25?); //TODO
...
#define TRACE_IMX412_STOP_STREAMING_DISABLE_RESET  1    /* DDD - imx412_stop_streaming() - disable VC MIPI reset */
#define TRACE_IMX412_STOP_STREAMING_VC             1    /* DDD - imx412_stop_streaming() - trace VC stuff */
...
#define DUMP_V4L_PARAMS         0   /* DDD - imx412_board_setup() - dump V4L params */
...
//	dev_err(dev, "%s(): Detected imx412 sensor - %s/%s\n", __func__), __DATE__, __TIME__);
	dev_err(dev, "%s(): Detected imx412 sensor - ", __func__);
